...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="PIN_INTERRUPT" URI="http://resources/4.0.2/app/PIN_INTERRUPT/0" description="The PIN_INTERRUPT APP invokes user interrupt handler in a response &#xA;to rising and/or falling edge event signal on a pin." mode="NOTSHARABLE" version="4.0.2" minDaveVersion="4.0.0" instanceLabel="CLAMP_INTERRUPT" appLabel="">
  ...
  <hwResources name="ers_etl" URI="http://resources/4.0.2/app/PIN_INTERRUPT/0/hwres_eru_ers_etl" resourceGroupUri="peripheral/eru/*/ers_etl/*" mResGrpUri="peripheral/eru/*/ers_etl/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/ERU1/ERU1_1.dd#//@provided.40"/>
  </hwResources>
  ...
  <hwResources name="Pin" URI="http://resources/4.0.2/app/PIN_INTERRUPT/0/__pin_hwres_port_pin" resourceGroupUri="devicepackage/0/50" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
